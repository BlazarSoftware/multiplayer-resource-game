...
@export var torso_id: String = "TORSO_01_1"
@export var pants_id: String = "PANTS_01_1"
@export var shoes_id: String = "SHOES_01_1"
@export var arms_id: String = "" # empty = default (base model arms)
